...
static inline snapu32_t mf_get32le(const snap_membus_t & busline, mfb_byteoffset_t lowest_byte)
{
    mfb_bitoffset_t o_bit= MFB_TOBITOFFSET(lowest_byte);
...
static inline void mf_set32le(snap_membus_t & busline, mfb_byteoffset_t lowest_byte, snapu32_t value)
{
    mfb_bitoffset_t o_bit= MFB_TOBITOFFSET(lowest_byte);
    busline(o_bit +  7, o_bit +  0) = value >>  0;
    busline(o_bit + 15, o_bit +  8) = value >>  8;
...
static inline snapu32_t mf_get32be(const snap_membus_t & busline, mfb_byteoffset_t lowest_byte)
{
    mfb_bitoffset_t o_bit= MFB_TOBITOFFSET(lowest_byte);
...
static inline void mf_set32be(snap_membus_t & busline, mfb_byteoffset_t lowest_byte, snapu32_t value)
{
    mfb_bitoffset_t o_bit= MFB_TOBITOFFSET(lowest_byte);
...
static inline snapu16_t mf_get16le(const snap_membus_t & busline, mfb_byteoffset_t lowest_byte)
{
    mfb_bitoffset_t o_bit= MFB_TOBITOFFSET(lowest_byte);
...
static inline void mf_set16le(snap_membus_t & busline, mfb_byteoffset_t lowest_byte, snapu16_t value)
{
    mfb_bitoffset_t o_bit= MFB_TOBITOFFSET(lowest_byte);
    busline(o_bit +  7, o_bit +  0) = value << 0;
    busline(o_bit + 15, o_bit +  8) = value << 8;
...
static inline snapu16_t mf_get16be(const snap_membus_t & busline, mfb_byteoffset_t lowest_byte)
{
    mfb_bitoffset_t o_bit= MFB_TOBITOFFSET(lowest_byte);
...
static inline void mf_set16be(snap_membus_t & busline, mfb_byteoffset_t lowest_byte, snapu16_t value)
{
    mfb_bitoffset_t o_bit= MFB_TOBITOFFSET(lowest_byte);
...
static inline snapu8_t mf_get8(const snap_membus_t & busline, mfb_byteoffset_t lowest_byte)
{
    mfb_bitoffset_t o_bit= MFB_TOBITOFFSET(lowest_byte);
    return (snapu16_t)busline(o_bit +  7, o_bit +  0);
}

static inline void mf_set8(snap_membus_t & busline, mfb_byteoffset_t lowest_byte, snapu8_t value)
{
    mfb_bitoffset_t o_bit= MFB_TOBITOFFSET(lowest_byte);
