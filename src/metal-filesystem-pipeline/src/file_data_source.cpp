...
size_t FileDataSource::reportTotalSize() { return loadExtents(); }

FileDataSource::FileDataSource(std::string filename, uint64_t offset,
                               uint64_t size)
...
FileDataSource::FileDataSource(std::vector<mtl_file_extent> &extents,
