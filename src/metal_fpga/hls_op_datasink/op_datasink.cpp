...
#pragma HLS INTERFACE axis register both port=length
#pragma HLS INTERFACE axis register both port=offset
#pragma HLS INTERFACE ap_ctrl_chain port=return

#pragma HLS INTERFACE m_axi port=dout bundle=host_mem depth=512 \
    max_read_burst_length=64 max_write_burst_length=64

#ifdef DRAM_ENABLED
#pragma HLS INTERFACE m_axi port=ddrout bundle=card_mem0 depth=512 \
    max_read_burst_length=64  max_write_burst_length=64
#endif
