...
begin
  ...
  with s_regState select p_nvme_WDATA <=
    ...
    std_logic_vector(s_cmdBufferAddr(63 downto 32)) when WrBufHi_AW,
    std_logic_vector(s_cmdBufferAddr(63 downto 32)) when WrBufHi_W,
    std_logic_vector(s_cmdBlockAddr(31 downto  0)) when WrBlkLo_AW,
    std_logic_vector(s_cmdBlockAddr(31 downto  0)) when WrBlkLo_W,
    std_logic_vector(s_cmdBlockAddr(63 downto 32)) when WrBlkHi_AW,
    std_logic_vector(s_cmdBlockAddr(63 downto 32)) when WrBlkHi_W,
