...
const snapu32_t action_id = 0xFB060001;
const snapu32_t action_rev = 0x00000001;

// ------------------------------------------------
// -------------- ACTION ENTRY POINT --------------
// ------------------------------------------------
void hls_action(snap_membus_512_t * din,
                snap_membus_512_t * dout,
...
#pragma HLS INTERFACE s_axilite port=action_id bundle=ctrl_reg offset=0x010
#pragma HLS INTERFACE s_axilite port=action_rev bundle=ctrl_reg offset=0x014
