#include "hls_operator_blowfish_encrypt.h"
...
void hls_operator_blowfish_encrypt(mtl_stream &in, mtl_stream &out, snapu32_t prepare, snapu32_t key_bytes[16]) {
    ...
    if (prepare) {
        bf_keyInit(key_bytes, encrypt_key);
    } else {
